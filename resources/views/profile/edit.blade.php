                ...
                <div class="max-w-xl">
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">Выйти из аккаунта</h3>
                                <p class="mt-1 text-sm text-gray-600">Используйте эту кнопку, чтобы завершить текущую сессию.</p>
                            </div>
